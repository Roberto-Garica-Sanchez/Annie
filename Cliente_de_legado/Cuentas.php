...
if (empty($_POST['name2set']))$_POST['name2set']='Nuevo';
sub_menu('','menu2','name2set','','Nuevo','Folder','Arc. Mur.','Modificar','Altas','Reporte','+','+','+','+','+','+');
echo"<div id='div_centro' style='position: relative;overflow: hidden;top: 45px;width: 1000px;height: 600px;background: url(../img/8.jpg);margin-right: auto;margin-left: auto;  '>";
...
{
$id='idI';
if(!empty($_POST[$name])){$_POST[$name2]=$_POST[$name];}
