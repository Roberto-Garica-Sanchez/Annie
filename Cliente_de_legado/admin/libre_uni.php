...
function ejecuta($conexion,$res,$phpv){
	...
	if ($phpv==php5) 	{$resu=mysql_query($res,$conexion) or die("\r<br>Error De Query \r<br>$res");}
	if ($phpv==php7) 	{$resu=mysqli_query($conexion,$res)or die("\r<br>Error De Query \r<br>$res");}
	return $resu;
}
