...
if(($config_all<>1)and($_POST[js]<>1))	{
	...
	echo"<script type='text/javascript' language='javascript' src='../admin2/libre_v1.js'></script> ";
	
}$config_all=1;
	$phpv=php5;
if($libre_v1<>1)		{$libre_v1=1;	
	class libre_v1	{		
		...
		function input2				($type2,$name,$title,$value,$style,$id,$libre,$class)										{
			...
			if($type2==label)$d="<label style='$style' id='$id' name='$name' title='$title' $libre >$value</label>";
			return $d;
		}
