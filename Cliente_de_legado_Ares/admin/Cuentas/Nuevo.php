...
//----------------------------------------------------------------------------------
if($dif1<0)		{$sd5="#ff002d33"; $ld5='red';}			else{$sd5="#21ff0033"; 	 $ld5='#21ff00';}
if($dif2<0)		{$sd9="#ff002d33"; $ld9='red';}			else{$sd9="#21ff0033"; 	 $ld9='#21ff00';}
if($n_c<10)		{$sd13="#ff002d33"; $ld13='red';}		else{$sd13="#21ff0033";  $ld13='#21ff00';}
if($re<30)		{$sd14="#ff002d33"; $ld14='red';}		else{$sd14="#21ff0033";  $ld14='#21ff00';}
if($dif1<0)	    {$indf16="#ff002d33"; $indc16='red';}	else{$indf16="#21ff0033"; $indc16='#21ff00';}
if($total10<0)	{$indf17="#ff002d33"; $indc17='red';}	else{$indf17="#21ff0033"; $indc17='#21ff00';}
if($pre_d<0)	{$indf18="#ff002d33"; $indc18='red';}	else{$indf18="#21ff0033"; $indc18='#21ff00';}
if($total9<0)	{$indf19="#ff002d33"; $indc19='red';}	else{$indf19="#21ff0033"; $indc19='#21ff00';}
if($dif4<0)	    {$indf20="#ff002d33"; $indc20='red';}	else{$indf20="#21ff0033"; $indc20='#21ff00';}
...
$ts="background: black;";
$i1=Casetas;		$d1=input2(button,'','',$total4);
$i2=Facturas;		$d2=input2(button,'','',$total5);
$i3=RyR;			$d3=input2(button,'','',$total6);
$i4=Guia;			$d4=input2(button,'','',$total7);
$i5=Maniobras;		$d5=input2(button,'','',$total8);
$i6='';				$d6='';					$tc6='#989898';
					$d7=input2(button,'','Gastos T.',$g_t,"background: orange;");
$i8=Viaticos;		$d8=input2(button,'','',$total2	,"background:  rgba(0, 81, 237, 1);");
$i9='';				$d9='';					$tc9='#989898';
$i10='';			$d10=input2(button,'','',$dif2 	,"background: $sd9; color: $ld9;");
$i11='';			$d11='';				$tc11=white;
$i12=Flete;			$d12=input2(button,'','',$_POST[flete_r]);
$i13='';			$d13='';				$tc13='#989898';
$i14=Chofer;		$d14=input2(button,'','',$c		,"background: orangered;");
$i15=Diesel;		$d15=input2(button,'','',$total3);
$i16=Comisiones;	$d16=input2(button,'','',$comi	);
$i17='Via pass';	$d17=input2(button,'','',$total4_via	);
$i18='';			$d18='';				$tc18='#989898';
$i19='';			$d19=input2(button,'',"+[$total4_via]Via Pass \n +[$total3]Diesel\n +[$t_g]Gasto T.\n +[$comi]Comision\n----------------\n =$t_d_g ",$t_d_g,"background: #0303fe66;");
...
$i6='';				$d6='';					$tc6='#989898';
					$d7=input2(button,'','Gastos T.',$g_t   ,'background: orange;');
$i8=Chofer;			$d8=input2(button,'','',$c	   ,'background: orangered;');
$i9='';				$d9='';					$tc9='#989898';
$i10='';			$d10=input2(button,'','',$t_g);
$i11=Viaticos;		$d11=input2(button,'','',$total2,"background:  rgba(0, 81, 237, 1);");
$i12='';			$d12='';				$tc12='#989898';
...
IF (($grava==1)&&($_POST[Grava]==Guardar)){
	//MYSQLI_QUERY($res,$conexion)or die("Error <br>$res");
...
$ts="background: black;";
$title1='Generales';
$i1="Gastos T.";   	$d1=input2(button,'',"Casetas[$total4] + Facturas[$total5] + RYR[$total6] + Guias[$total7] + Maniobras[$total8] =$g_t"	,$g_t,"background: orange;");
$i2=Chofer;			$d2=input2(button,'',"Flete[$total1] * 0.15= $c "								,$c,"background: orangered;");
$i3=ISR;			$d3=input2(button,'',"(Chofer[$c] * 7.5)/100 = $rete "							,$rete);
$i4=Viaticos;		$d4=input2(button,'',''															,$total2,"background:  rgba(0, 81, 237, 1);");
$i5='';				$d5=input2(button,'',"+[$total2]Viaticos\r+[$rete]Retencion\r -[$g_t]Gasto T.\r -[$c]chofer\r----------------\r[$dif1] Total ",$dif1,"background: $sd5; color: $ld5;");
$tc6='#989898';			$i6='';			$d6='';
$i7='Sin. Cho.';	$d7=input2(button,'',"Casetas[$total4] + Facturas[$total5] + RYR[$total6] + Guias[$total7] + Maniobras[$total8] =$g_t",$g_t,"background: orange;");
$i8=Viaticos;		$d8=input2(button,'',''															,$total2,"background:  rgba(0, 81, 237, 1);");
$i9='';				$d9=input2(button,'',"+Viaticos[$total2] -Gasto T.[$g_t] = $dif2 "				,$dif2,"background: $sd9; color: $ld9;");
$tc10='#989898';	$i10='';			$d10='';
$i11=Flete;			$d11=input2(button,'',''														,$_POST[flete_r]);
$i12='Total G.';	$d12=input2(button,'',"+[$total4_via]Via Pass \n +[$total3]Diesel\n +[$t_g]Gasto T.\n +[$comi]Comision\n----------------\n =$t_d_g ",$t_d_g,"background: #0303fe66;");
$i13='Neto Carro';	$d13=input2(button,'',"Neto Camion[$n_c] / (fletes[$_POST[flete_r] * 0.01) = $re "	,$n_c,"background: $sd13; color: $ld13;");
$i14=Rendimiento;	$d14=input2(button,'','',$re,"background: $sd14; color: $ld14;");
$i15='Cuentas';		$d15='';			$tc15='#000';
$i16='Actual';		$d16=input2(button,'',"+[$total2]Viaticos\r -[$rete]Retencion\r -[$g_t]Gasto T.\r -[$c]chofer\r----------------\r[$dif1] Total ",$dif1,"background: $indf16; color: $indc16;");
$i17='Arrastado';	$d17=input2(button,'',"Suma de todas las Cuentas Arastradas"					,$total10,"background: $indf17; color: $indc17;");
$i18='';			$d18=input2(button,'',"Actual[$dif1] + Arrastrada[$total10]= $dif3"				,$dif3,"background: $indf18; color: $indc18;");
$i19=Abonos;		$d19=input2(button,'',"Suma de los abonos de esta cuenta "						,$total9,"background: $indf19; color: $indc19;");
$i20=Total;			$d20=input2(button,'',"Arrastrado[$total10]-Abonos[$total9]=$dif4"				,$dif4,"background: $indf20; color: $indc20;");
include('tablero.php');
