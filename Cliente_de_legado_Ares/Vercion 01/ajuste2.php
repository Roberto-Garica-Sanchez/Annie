...
echo "<div id='Consola2' class='$class'>";
	...
	echo"<div style='position: absolute;top: 2px;bottom: 2px;left: 2px;right: 2px;background: white;'>";
		echo $Consola2;
		echo $resc;
	echo"</div>";
echo "</div>";
...
echo"<div id='general_info' style='background: #05486cab;width: 220px;right: 0px;top: 12px;bottom: 5px;position: absolute;color: white;'>";
	echo"<div id='datos_info'>";
		if($_POST[sub1]==Operadores){
			...
			echo libre_v1::input2(text,chofer,'',$_POST[chofer]			,$style_chofer."width: 60%",'',"maxlength='50' placeholder='Nombre Completo' onkeyup='Maysall(this);'",botones_submenu);
...
echo"<div style='position: absolute;top: 0px;bottom: 0px;right: 225px;left: 120px;background: #05486cab;box-shadow: inset 0px 0px 1px 1px white;'>";
	...
	if($_POST[sub1]==Operadores){
		...
		//lista de choferes
		echo libre_v1::input2(text,busca,'',$_POST[busca],'width: 165px;padding: 2px 5px;','',"placeholder='Buscador'onkeyup='Maysall(this);'");
		echo libre_v1::input2(submit,'','',Buscar,'width: 65px;padding: 2px;background: #102f41;color: white;');
...
if($_POST[chofer]==''){
	echo"<div style='position: absolute;top: 0px;bottom: 100px;left: 105px;right: 225px;background: #05486cab;padding: 5px;    '>";
		...
		if($_POST[sub1]==Operadores){
			...
			$consu=libre_v2::consulta(choferes,$conexion,'','',Nombre_Ch,0,$phpv,'','');
			while($datos=libre_v1::mysql_fe_ar	($consu,$phpv)){
				echo libre_v1::input2(submit,'descarga_chofer','',$datos[Nombre_Ch],"width: 300px;",'',"",botones_submenu);
				//echo libre_v1::input2(text,'','',$datos[Nombre_Ch] 					,"width: 250px;",'',"disabled",botone_n);
				echo"<br>";
			}				
			echo"</div>";
		}
...
if($_POST[chofer]<>''){
		...
		$datos=libre_v1::mysql_fe_ar($consu,$phpv);
	echo"<div>";
		libre_v1::input2(button,'','',"Ultimo Viaje");
		echo"<br>";
		libre_v1::input2(button,'','',"Estado ");
		libre_v1::input2(button,'','',"Facturas Vinculadas");
	echo"</div>";
}
if($_POST[sub1]==Clientes){
	...
	while($datos=libre_v1::mysql_fe_ar	($consu,$phpv)){
		echo libre_v1::input2(submit,'descarga_cliente','',$datos[Nombre_Cl] 					,"width: 300px;",'',"",botones_submenu);
		//echo libre_v1::input2(text,'','',$datos[Nombre_Ch] 					,"width: 250px;",'',"disabled",botone_n);
		echo"<br>";
	}				
	echo"</div>";
