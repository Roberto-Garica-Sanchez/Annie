...
echo libre_v2::menu2(submit,$style,'id="sub_menu"',name2set,idI,id_I,Nuevo,Folder,'Arc. Mur.',Modificar,Altas,Reporte,$v7,$v8,$v9,$v10,$v11,' ')	;
if($_POST[Soft_version]==''){$_POST[Soft_version]="Ares";}
echo libre_v1::input2(hidden,D_i,'',$_POST[D_i],$style,'',$libre);
echo libre_v1::input2(hidden,M_i,'',$_POST[M_i],$style,'',$libre);
echo libre_v1::input2(hidden,A_i,'',$_POST[A_i],$style,'',$libre);
echo libre_v1::input2(hidden,D_f,'',$_POST[D_f],$style,'',$libre);
echo libre_v1::input2(hidden,M_f,'',$_POST[M_f],$style,'',$libre);
echo libre_v1::input2(hidden,A_f,'',$_POST[A_f],$style,'',$libre);
