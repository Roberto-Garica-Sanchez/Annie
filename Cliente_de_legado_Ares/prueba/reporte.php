...
";
		...
		mysql_data_seek($consu1_2,0);
		while($datos=mysql_fetch_array($consu1_2)){
			$color='';
...
IF($_POST['menu-list']==Diesel)$color=yellowgreen;
$n5=input(submit,'menu-list',Diesel		,'',"background: $color;");$color='';
