...
*/
	...
	if($proce1<>2){
		...
		if ($_POST[regis]==Login){
			...
			$img=	input2(image,'','',''				,"position: absolute; top: 160px;  left: 55px; width: 50px; height 50px;",'',"src='../img/user-sistem.png'disabled");
			$can=	input2(image,'','',''				,"position: absolute; top: 230px; left: 55px; width: 50px; height 50px;",'',"src='../img/candado-sistem.png'disabled");
			...
			$log=	input2(image,'logo','',''			,"position: absolute; top: 50px;  left: 150px; ",'','src="../img/logo.jpg"disabled');
		...
		if ($_POST[regis]==Registrarse){
			...
			$img=	input2(image,'','',''				,"position: absolute; top: 60px;  left: 55px; width: 30px; height 50px;",'',"src='../img/user-sistem.png' disabled");
			$can=	input2(image,'','',''				,"position: absolute; top: 120px; left: 55px; width: 30px; height 50px;",'',"src='../img/candado-sistem.png'disabled");
			$can2=	input2(image,'','',''				,"position: absolute; top: 180px; left: 55px; width: 30px; height 50px;",'',"src='../img/candado-sistem.png'disabled");
			$can3=	input2(image,'','',''				,"position: absolute; top: 420px; left: 55px; width: 30px; height 50px;",'',"src='../img/candado-sistem.png'disabled");
			$lla=	input2(image,'','',''				,"position: absolute; top: 240px; left: 55px; width: 30px; height 50px;",'',"src='../img/llave-sistem.png'disabled");
			$adm=	input2(image,'','',''				,"position: absolute; top: 360px; left: 55px; width: 40px; height 50px;",'',"src='../img/admin-sistem.png'disabled");
