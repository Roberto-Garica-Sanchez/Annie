<?php
    #calculos antes de guardar 
    if(!empty($_POST['Contador_Final']) and !empty($_POST['Contador_Inicio']))$_POST['Total_Despachado']=$_POST['Contador_Final']-$_POST['Contador_Inicio'];
