...
$login=1;
	...
	if($proce1<>2){
		...
		if ($_POST[regis]==Login){
			...
			$style="position: relative; width: 400px; height: 400px; background: rgba(59, 117, 176, 0.63); margin-left: auto; margin-right: auto;	margin-top: auto; margin-bottom: auto; box-shadow: 0px 10px 10px 1px #0f4e9f;";
