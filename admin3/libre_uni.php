...
$libre_uni=1;
$phpv=php5;
//if($_POST[operacion]<>index){
echo"<LINK REL='STYLESHEET' HREF='".$ruta."estilo.css' />";
//echo"<script  src='".$ruta."java1.js'></script> ";
//}
/*
...
function menu				($style,$libre,$name,$v1,$v2,$v3,$v4,$v5,$v6,$v7,$v8,$v9,$v10,$v11)								{	
	...
	if($v11<>'')$conte=$conte.input2(submit,$name,'',$v11,"",$d11);
...
function contenedor($id,$caption,$style,$contenido){
	...
	if($style_cont=="")	$style_cont =	$style_cont.	"background: rgba(5, 72, 108, 0.51);";
						...
						$style		= 	$style.			"/*overflow: hidden; */position: absolute;";
						$style_cont	= 	$style_cont.	"width: 100%; height: auto; position: absolute; top: 30px;";
						$res		=	$res.			div($style_cont,"",$contenido);
						$res		=					div($style,"id='$id'",$res);
	return $res;
}
}
?>