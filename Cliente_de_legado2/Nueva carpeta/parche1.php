...
function general		($style0,$conexion,$phpv,$cuenta){
	...
	for($x=1; $x<=20; $x++){
		...
		for($y=1; $y<10; $y++){	
			...
			$libre_all="";
			if(($x>5)&&($y==1))	{$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 1  -> fletes
			if(($x>5)&&($y==2))	{$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 2  -> casetas
			if(($x>7)&&($y==3))	{$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 3  -> diesel
			if(($x>20)&&($y==4)){$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 4  -> casetas
			if(($x>5)&&($y==5))	{$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 5  -> facturas
			if(($x>10)&&($y==6)){$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 6  -> "r y r "
			if(($x>5)&&($y==7))	{$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 7  -> "Guias "
			if(($x>10)&&($y==8)){$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 8  -> "Maniobras "
			if(($x>20)&&($y==9)){$style1="background: white; color: #0075ff;";$libre_all='readonly="readonly"';}//limite 9  -> via pass
			...
			$general=$general.libre_v1::input2($TYPE,$name,$title,$value,$style_all.$style1,$id,$libre_all.'onKeyUp="mueve_diba_text(event,this); 	calcula_update();"');
			//$conta=$conta+1;
			//$id=$conta;
		}
		$general=$general."<br>";	
	...
	$res=$res."<div style='background: rgba(0, 0, 0, 0.76); width: auto; height: auto; position: absolute; top: 0px; $style0' >$general</div>";
	
		
	//windows 2
	//$style1="width: 660px; height: 460px; background: rgba(5, 72, 108, 0.67); position: absolute; top: 20px; left: 100px;";
	if($style1=="")$style1=" ";
	//$div_celda=libre_v1::windows			(General,$style1,$style2,$general);
	return $res;
}
...
function arrastrados	($win,$conexion,$phpv,$cuenta){	
		...
		$conte=$conte."</table>";
		$text="background: #343434; color: #0075ff;";
		$conte=$conte."<div style='overflow-x: hidden; overflow-y: auto; max-height: 500px; right: 0px; bottom: 0px; position: relative; left: 0px;'>";
	...
	//$style1="width: 300px; height: 205px; background: rgba(5, 72, 108, 0.67); position: absolute; left: 100px; bottom: 0px;";
	$style1=" ";	
	if($win==""){$win=min;}
	//$div_arrastrar=libre_v1::windows			(Arrastrar,$style1,$style2,$conte,$win);
	$res="<div style='    position: absolute; top: 500px; left: 600px; background: RGBA(49, 114, 177, 0.8); max-height: 300px;'>$conte</div>";
	return $res;
}
...
function consola(){
	...
	$parche1_config=$parche1_config."<LINK REL='STYLESHEET' HREF='parche1.css' TYPE='TEXT/CSS'/> ";
?>