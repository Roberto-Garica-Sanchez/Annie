...
$i5=Chofer;             $d5=despliegre_mysql(chofer,Chofer,$consu1,Nombre_Ch,"onchange='desca_arrasta(this);'onclick='desca_arrasta(this);'");
...
IF ($_POST[km_i]>$_POST[km_f])	{$dc11=$dc12=pink;$grava=0;} 
$size=0;
$style="    background: rgba(5, 72, 108, 0.67) none repeat scroll 0% 0%; width: 220px; right: 0px; color: white; position: fixed;     top: 55px;";
$title='Nueva Cuenta';
$libre1=focuas_a(4,D);
$libre2=focuas_a(2,M);
$libre3=focuas_a(2,A);
...
$i10='Flete R.';        $d10=input(text,flete_r,$_POST[flete_r],'','','maxlength="10" id="flete_r"');
$i11="Kms inicio";      $d11=input(text,km_i,$_POST[km_i],'','','maxlength="10"id="km_i"');
$i12="Kms fin";         $d12=input(text,km_f,$_POST[km_f],'','','id="km_f"');
...
echo"<TEXTAREA style='
    ...
    margin: 0px;
    z-index: 1;' >";
		IF (($grava==1)&&($_POST[Grava]==Guardar))echo"Guardado inicio  ";
	//-----------------------------------------------------------
	...
	IF (($grava==1)&&($_POST[Grava]==Guardar))echo" \rGuardado Finalizado";
	IF (($grava==1)&&($_POST[Grava]==Guardar))echo" \rActualizador Iniciado";

	$consu24=consulta('abo_acu',$conexion);
	Actua($_POST[Carta1],$grava,$conexion);
		IF (($grava==1)&&($_POST[Grava]==Guardar))echo" \rActualizador Finalizado";
