...
echo"<LINK REL='STYLESHEET' HREF='../admin2/contenedores_v1.css'/>";
echo"<div id='style_co_centro'>";
	if ($_POST[name2set]==Agregar)		{include("nuevo2.php");}	
	if ($_POST[name2set]==Nuevo)		{$_POST[win_carga]=Nuevo;include("windows.php");}
