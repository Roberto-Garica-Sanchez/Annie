...
$ts="background: black;";
$title1='Generales';
$i1=Chofer;			$d1=input2(button,'',"Flete[$total1] * 0.15= $c "								,$c,"background: orangered;");
$i2=ISR;			$d2=input2(button,'',"(Chofer[$c] * 7.5)/100 = $rete "							,$rete);
$i3='';				$d3=input2(button,'',"",$c-$rete);
$i4="Gastos T.";   	$d4=input2(button,'',"Casetas[$total4] + Facturas[$total5] + RYR[$total6] + Guias[$total7] + Maniobras[$total8] =$g_t"	,$g_t,"background: orange;");
$i5=Viaticos;		$d5=input2(button,'',''															,$total2,"background:  rgba(0, 81, 237, 1);");
...
$tc7='#989898';		$i7='';			$d7='';
$i8='Sin. Cho.';	$d8=input2(button,'',"Casetas[$total4] + Facturas[$total5] + RYR[$total6] + Guias[$total7] + Maniobras[$total8] =$g_t",$g_t,"background: orange;");
$i9=Viaticos;		$d9=input2(button,'',''															,$total2,"background:  rgba(0, 81, 237, 1);");
$i10='';			$d10=input2(button,'',"+Viaticos[$total2] -Gasto T.[$g_t] = $dif2 "				,$dif2,"background: $sd9; color: $ld9;");
$tc11='#989898';	$i11='';			$d11='';
$i12=Flete;			$d12=input2(button,'',''														,$_POST[flete_r]);
$i13='Total G.';	$d13=input2(button,'',"Via Pass [$total4_via] +Diesel[$total3] +Gasto T.[$t_g] + Comision[$comi] = $t_d_g ",$t_d_g,"background: #0303fe66;");
			...
			if ($c2<>''){
				...
				if ($c2<>$c1){
					...
					IF (($grava==1)&&($_POST[Grava]==Guardar)&&($fec_fin>=20160601)){
						echo"\r".$res;
						//MYSQLi_QUERY($res,$conexion)or die("Error \r$res\r");
						ejecuta($conexion,$res);
					}
				}
			}
