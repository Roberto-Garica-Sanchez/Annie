<?php
	...
	echo"<div style='position: relative;width: 1175px;height: 600px;background: black; color: white;margin-left: auto;margin-right: auto;margin-top: auto;margin-bottom: auto;box-shadow: 0px 10px 10px 1px #0009; color: white;'>";	
		...
		echo "<div style='position: absolute;background: #444;top: 5px;left: 5px;right: 5px;height: 90px'>";		
			...
			echo "<div style='position: absolute;bottom: 15px;left: 50px;width: 400px;'>";		
				...
				echo libre_v1::input2(button,'','','New Register','position: absolute; bottom: 50px; right: -200px; height: 50px;width: 200px;  background: yellow;    font-size: 25px;','',"onclick='cambia();'");
			echo "</div>";
		echo "</div>";
		...
		echo "<div style='position: absolute;top: 105px;left: 10px;background: #444;'>";
					...
					echo libre_v1::input2(text,'','',"Entry Hour"		,'margin: .5px .5px .5px .5px; font-size: 20px; background: black; color: white;    padding: 5px 5px 5px 5px;','',"readonly='readonly'",'');
